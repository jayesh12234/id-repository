# Bundled MOSIP config (local deps stack)
...
| `kernel-default.properties` | Keymanager PKCS12 + DB host (`postgres`) |
...
Local overrides (examples): `postgres`, `mock-service:8082`, `keymanager-service:8088`, `minio:9000`, `mosip.auth.filter_disable=true`.
